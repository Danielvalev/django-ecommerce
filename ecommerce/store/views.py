...
def category_list(request, category_slug):
    category = get_object_or_404(Category, slug=category_slug)  # Return the category
    products = Product.objects.filter(category=category)  # Return all products with that category
