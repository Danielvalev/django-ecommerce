...
class TestBasketView(TestCase):
    def setUp(self):
        ...
        Product.objects.create(category_id=1, title='django intermediate', created_by_id=1, slug='django-intermediate',
                               price='20.00', image='django')
        Product.objects.create(category_id=1, title='django advanced', created_by_id=1, slug='django-advanced',
                               price='20.00', image='django')
        self.client.post(
    ...
    def test_basket_delete(self):
        """
        Test delete item from the basket
        """
        response = self.client.post(
    ...
    def test_basket_update(self):
        """
        Test update item from the basket
        """
        response = self.client.post(
